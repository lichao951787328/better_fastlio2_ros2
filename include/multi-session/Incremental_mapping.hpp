...
class IncreMapping
{
  public:
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubCentralTrajectory;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubRegisteredTrajectory;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubCentralGlobalMap;
