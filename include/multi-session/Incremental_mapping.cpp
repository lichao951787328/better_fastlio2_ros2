...
void MultiSession::Session::loadSessionGraph() 
{
    ...
    // 
    std::cout << "\033[1;32m Session loaded: " << posefile_path << "\033[0m" << std::endl;
    std::cout << "\033[1;32m - num nodes: " << nodes_.size() << "\033[0m" << std::endl;
}
...
void MultiSession::Session::loadGlobalMap(){
    ...
    std::cout << "\033[1;32m Map loaded: " << mapfile_path << "\033[0m" << std::endl;
}
...
void MultiSession::IncreMapping::detectInterSessionSCloops() // using ScanContext
{
    ...
    std::cout << "\033[1;32m Total " << SCLoopIdxPairs_.size() << " inter-session loops are found. Average time "<<  ave_time <<  " \033[0m" << std::endl;
...
void MultiSession::IncreMapping::loadAllSessions() {
    // pose 
    std::cout << "\033[1;32m Load sessions' pose data from: " << sessions_dir_ << "\033[0m" << std::endl;
    ...
    std::cout << "\033[1;32m Total : " << sessions_.size() << " sessions are loaded.\033[0m" << std::endl;
