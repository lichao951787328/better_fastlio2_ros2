...
#include <fast_lio_sam/msg/cloud_info.hpp>
...
sensor_msgs::msg::Image::SharedPtr cvmat2msg(const cv::Mat &_img)
{
  sensor_msgs::msg::Image::SharedPtr msg = cv_bridge::CvImage(std_msgs::msg::Header(), "bgr8", _img).toImageMsg();
  return msg;
}
